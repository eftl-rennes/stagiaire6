...
WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Register/input_First name_FirstName'), 'philippe')
...
WebUI.verifyElementPresent(findTestObject('Page_Demo Web Shop. Register/span_Last name is required.'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Demo Web Shop. Register/span_Last name is required.'), 'Last name is required.')
