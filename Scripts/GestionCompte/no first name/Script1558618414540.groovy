...
WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Register/input_Last name_LastName'), 'dussaucy')
...
WebUI.verifyElementPresent(findTestObject('Page_Demo Web Shop. Register/span_First name is required.'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Demo Web Shop. Register/span_First name is required.'), 'First name is required.')
